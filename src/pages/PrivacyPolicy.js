							...
							ParagraphComponent={() => (
								<>
									<p className="pt-5 text-base font-thin ">
										At Wiingr, we prioritize your privacy above all else. It
										forms the foundation of our service and product development,
									...
									<p className="pt-5 text-base font-thin ">
										<strong>
											Our dedication to safeguarding your privacy.{" "}
										</strong>
										Our approach to product and service design is centered
										around your privacy. We engage experts from diverse fields
										such as legal, security, engineering, and product design to
										ensure that every decision we make is grounded in the
										highest regard for your privacy.
									</p>
									<p className="pt-5 text-base font-thin ">
										...
										and overly complex language. In contrast, we are committed
										to transparency and clarity. Our Privacy Policy and related
										documents are written in plain language, aiming for
										simplicity and comprehension. We genuinely encourage you to
										read and understand our privacy practices.
									</p>
									<p className="pt-5 text-base font-thin ">
										<strong>Our dedication to ensuring security. </strong>
										Dedicated teams are committed to safeguarding your data,
										continuously updating our security protocols and investing
										in ongoing efforts to fortify the protection of your
										information.
									</p>
								</>
							)}
