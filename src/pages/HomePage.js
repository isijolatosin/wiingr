				...
				<div className="mx-auto max-w-max-content-width h-[85vh] flex justify-center items-center px-4 text-center leading-5 font-thin">
					<div>
						...
						<p className="pt-1 text-base font-thin text-left">
							...
							result, it is not open to the public at this time. We are
							diligently working to finalize the necessary preparations to
							ensure a smooth and successful launch.
							<br />
							<br />
							Please bear with us as we complete this process. We are committed
							to providing you with an exceptional experience once the website
							is ready for public access. In the meantime, we appreciate your
